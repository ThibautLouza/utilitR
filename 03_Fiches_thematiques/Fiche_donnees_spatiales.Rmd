...
l'API Métadonnées [lien vers la fiche API quand elle sera finie]
...
* la documentation du *package* `sf` :
    ...
    - la [*cheeatsheet*](https://github.com/rstudio/cheatsheets/raw/master/sf.pdf) du *package* (en anglais) ;
